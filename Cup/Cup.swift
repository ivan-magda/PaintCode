...
//  Blagaprint
//
//  Created by Ivan Magda on 21.12.15.
...
public class Cup : NSObject {
    ...
    public class func drawCupFront(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(named: "pickedImage.png")!, imageVisible: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()


        //// Image Declarations
        let cupFrontImage = UIImage(named: "cupFrontImage.png")!
        ...
        CGContextSaveGState(context)
        rectanglePath.addClip()
        cupFrontImage.drawInRect(CGRectMake(floor(rectangleRect.minX + 0.5), floor(rectangleRect.minY + 0.5), cupFrontImage.size.width, cupFrontImage.size.height))
        CGContextRestoreGState(context)


        if (imageVisible) {
            //// PickedImageRectangle Drawing
            let pickedImageRectangleRect = CGRectMake(frame.minX + 71.68, frame.minY + 40, 196.5, 220)
            let pickedImageRectanglePath = UIBezierPath()
            pickedImageRectanglePath.moveToPoint(CGPointMake(frame.minX + 73.6, frame.minY + 155))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 75.5, frame.minY + 199.36), controlPoint1: CGPointMake(frame.minX + 74.2, frame.minY + 170.13), controlPoint2: CGPointMake(frame.minX + 74.72, frame.minY + 185.36))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 82.01, frame.minY + 260), controlPoint1: CGPointMake(frame.minX + 77.39, frame.minY + 233.35), controlPoint2: CGPointMake(frame.minX + 80.23, frame.minY + 260))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 262.7, frame.minY + 260), controlPoint1: CGPointMake(frame.minX + 87.25, frame.minY + 260), controlPoint2: CGPointMake(frame.minX + 259.7, frame.minY + 260))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 264.46, frame.minY + 256.53), controlPoint1: CGPointMake(frame.minX + 262.92, frame.minY + 260), controlPoint2: CGPointMake(frame.minX + 264.18, frame.minY + 258.78))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 268.11, frame.minY + 140.96), controlPoint1: CGPointMake(frame.minX + 266.19, frame.minY + 242.73), controlPoint2: CGPointMake(frame.minX + 267.8, frame.minY + 190.01))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 267.61, frame.minY + 40), controlPoint1: CGPointMake(frame.minX + 268.43, frame.minY + 89.27), controlPoint2: CGPointMake(frame.minX + 267.61, frame.minY + 40))
            pickedImageRectanglePath.addLineToPoint(CGPointMake(frame.minX + 72, frame.minY + 40))
            pickedImageRectanglePath.addCurveToPoint(CGPointMake(frame.minX + 73.6, frame.minY + 155), controlPoint1: CGPointMake(frame.minX + 71.48, frame.minY + 40), controlPoint2: CGPointMake(frame.minX + 71.35, frame.minY + 98.12))
            pickedImageRectanglePath.closePath()
            CGContextSaveGState(context)
            pickedImageRectanglePath.addClip()
            pickedImage.drawInRect(CGRectMake(floor(pickedImageRectangleRect.minX + 0.5), floor(pickedImageRectangleRect.minY + 0.5), pickedImage.size.width, pickedImage.size.height))
    ...
    public class func imageOfCupFront(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(named: "pickedImage.png")!, imageVisible: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            Cup.drawCupFront(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), pickedImage: pickedImage, imageVisible: imageVisible)

        let imageOfCupFront = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfCupFront
    }
